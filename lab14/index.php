...
<div class="container">
	...
	<? include "inc/nav.php" ?>
	<section class="lead">
		<h2>Wellcome to the World of Isaac Newton</h2>
		<figure>
			<img src="images/image1.png" alt="Isaac Neweton" onmouseover="src='images/image2.png'" onmouseout="src='images/image1.png'">
			<figcaption>This is an image about Sir Isaac Newton</figcaption>
		</figure>
		<div>
			<div>
				<h3>About Newton</h3>
